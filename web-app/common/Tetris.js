...
//Added held_tetromino and can_hold added to the type definition.
/**
 ...
 * @property {boolean} can_hold Determines whether a piece can be held.
...
/**
 * The height of a minitetris field.
 * Includes buffer rows at the top that may not be visible.
 * @constant
 * @memberof Tetris
 * @default
...
/**
 * Perform a hard drop, where the piece immediately fully descends
 ...
 * Holds can not be performed twice in a turn, so after the initial hold
 * the piece now in play must be played to the next turn.
 * @function
 * @memberof Tetris
 * @param {Tetris.Game} game The initial state of a game.
